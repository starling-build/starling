/* GENERATED — do not edit. Character width and joining tables extracted
   from python wcwidth 0.8.2 (Unicode 17.0.0), the exact library
   ucs-detect grades terminals against, so the emulator and the grader
   agree by construction. Regenerate with the script in this file's git
   introduction commit whenever wcwidth is updated. Consumed only by
   starling_term.c, which supplies CpRange and in_ranges(). */

/* width 0: combining, format, Mn+Mc per wcwidth's model */
static const CpRange gen_zero_tbl[] = {
    {0x0,0x0},{0x300,0x36F},{0x483,0x489},{0x591,0x5BD},{0x5BF,0x5BF},
    {0x5C1,0x5C2},{0x5C4,0x5C5},{0x5C7,0x5C7},{0x610,0x61A},{0x61C,0x61C},
    {0x64B,0x65F},{0x670,0x670},{0x6D6,0x6DC},{0x6DF,0x6E4},{0x6E7,0x6E8},
    {0x6EA,0x6ED},{0x711,0x711},{0x730,0x74A},{0x7A6,0x7B0},{0x7EB,0x7F3},
    {0x7FD,0x7FD},{0x816,0x819},{0x81B,0x823},{0x825,0x827},{0x829,0x82D},
    {0x859,0x85B},{0x897,0x89F},{0x8CA,0x8E1},{0x8E3,0x903},{0x93A,0x93C},
    {0x93E,0x94F},{0x951,0x957},{0x962,0x963},{0x981,0x983},{0x9BC,0x9BC},
    {0x9BE,0x9C4},{0x9C7,0x9C8},{0x9CB,0x9CD},{0x9D7,0x9D7},{0x9E2,0x9E3},
    {0x9FE,0x9FE},{0xA01,0xA03},{0xA3C,0xA3C},{0xA3E,0xA42},{0xA47,0xA48},
    {0xA4B,0xA4D},{0xA51,0xA51},{0xA70,0xA71},{0xA75,0xA75},{0xA81,0xA83},
    {0xABC,0xABC},{0xABE,0xAC5},{0xAC7,0xAC9},{0xACB,0xACD},{0xAE2,0xAE3},
    {0xAFA,0xAFF},{0xB01,0xB03},{0xB3C,0xB3C},{0xB3E,0xB44},{0xB47,0xB48},
    {0xB4B,0xB4D},{0xB55,0xB57},{0xB62,0xB63},{0xB82,0xB82},{0xBBE,0xBC2},
    {0xBC6,0xBC8},{0xBCA,0xBCD},{0xBD7,0xBD7},{0xC00,0xC04},{0xC3C,0xC3C},
    {0xC3E,0xC44},{0xC46,0xC48},{0xC4A,0xC4D},{0xC55,0xC56},{0xC62,0xC63},
    {0xC81,0xC83},{0xCBC,0xCBC},{0xCBE,0xCC4},{0xCC6,0xCC8},{0xCCA,0xCCD},
    {0xCD5,0xCD6},{0xCE2,0xCE3},{0xCF3,0xCF3},{0xD00,0xD03},{0xD3B,0xD3C},
    ...
    {0x108F,0x108F},{0x109A,0x109D},{0x1160,0x11FF},{0x135D,0x135F},
    ...
    {0x1A55,0x1A5E},{0x1A60,0x1A7C},{0x1A7F,0x1A7F},{0x1AB0,0x1ADD},
    {0x1AE0,0x1AEB},{0x1B00,0x1B04},{0x1B34,0x1B44},{0x1B6B,0x1B73},
    ...
    {0x2DE0,0x2DFF},{0x302A,0x302F},{0x3099,0x309A},{0x3164,0x3164},
    ...
    {0xAAF5,0xAAF6},{0xABE3,0xABEA},{0xABEC,0xABED},{0xD7B0,0xD7FF},
    {0xFB1E,0xFB1E},{0xFE00,0xFE0F},{0xFE20,0xFE2F},{0xFEFF,0xFEFF},
    {0xFFA0,0xFFA0},{0xFFF0,0xFFFB},{0x101FD,0x101FD},{0x102E0,0x102E0},
    ...
    {0x16FF0,0x16FF1},{0x1BC9D,0x1BC9E},{0x1BCA0,0x1BCA3},{0x1CF00,0x1CF2D},
...
/* width 2: East Asian Wide/Fullwidth + emoji presentation */
static const CpRange gen_wide_tbl[] = {
...
/* spacing combining marks: joining one makes the cluster 2 cells */
static const CpRange gen_mc_tbl[] = {
    ...
    {0x302E,0x302F},{0xA823,0xA824},{0xA827,0xA827},{0xA880,0xA881},
...
/* viramas: the following consonant joins, cluster capped at 2 cells */
static const CpRange gen_virama_tbl[] = {
    {0x94D,0x94D},{0x9CD,0x9CD},{0xA4D,0xA4D},{0xACD,0xACD},{0xB4D,0xB4D},
    {0xBCD,0xBCD},{0xC4D,0xC4D},{0xCCD,0xCCD},{0xD4D,0xD4D},{0xDCA,0xDCA},
    {0x1039,0x1039},{0x17D2,0x17D2},{0x1A60,0x1A60},{0x1B44,0x1B44},
    {0x1BAB,0x1BAB},{0xA806,0xA806},{0xA8C4,0xA8C4},{0xA9C0,0xA9C0},
    {0xAAF6,0xAAF6},{0x10A3F,0x10A3F},{0x11046,0x11046},{0x110B9,0x110B9},
    {0x11133,0x11133},{0x111C0,0x111C0},{0x11235,0x11235},{0x1134D,0x1134D},
    {0x113D0,0x113D0},{0x11442,0x11442},{0x114C2,0x114C2},{0x115BF,0x115BF},
    {0x1163F,0x1163F},{0x116B6,0x116B6},{0x11839,0x11839},{0x1193E,0x1193E},
    {0x119E0,0x119E0},{0x11A47,0x11A47},{0x11A99,0x11A99},{0x11C3F,0x11C3F},
    {0x11D45,0x11D45},{0x11D97,0x11D97},{0x11F42,0x11F42},
};

/* bases VS16 widens */
static const CpRange gen_vs16_base_tbl[] = {
    {0x23,0x23},{0x2A,0x2A},{0x30,0x39},{0xA9,0xA9},{0xAE,0xAE},{0x203C,0x203C},
    {0x2049,0x2049},{0x2122,0x2122},{0x2139,0x2139},{0x2194,0x2199},
    {0x21A9,0x21AA},{0x2328,0x2328},{0x23CF,0x23CF},{0x23ED,0x23EF},
    ...
    {0x2B05,0x2B07},{0x1F170,0x1F171},{0x1F17E,0x1F17F},{0x1F321,0x1F321},
    ...
    {0x1F5FA,0x1F5FA},{0x1F6CB,0x1F6CB},{0x1F6CD,0x1F6CF},{0x1F6E0,0x1F6E5},
    {0x1F6E9,0x1F6E9},{0x1F6F0,0x1F6F0},{0x1F6F3,0x1F6F3},
};

/* bases VS15 narrows */
static const CpRange gen_vs15_base_tbl[] = {
...
/* emoji bases a Fitzpatrick modifier (1F3FB-1F3FF) attaches to */
static const CpRange gen_emoji_zwj_tbl[] = {
    ...
    {0x3297,0x3297},{0x3299,0x3299},{0x1F004,0x1F004},{0x1F02C,0x1F02F},
    ...
    {0x1F191,0x1F19A},{0x1F1AE,0x1F1FF},{0x1F201,0x1F20F},{0x1F21A,0x1F21A},
    ...
    {0x1F39E,0x1F3F0},{0x1F3F3,0x1F3F5},{0x1F3F7,0x1F3FA},{0x1F400,0x1F4FD},
