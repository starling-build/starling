...
for v in FLUTTER_DRM_DPI FLUTTER_DRM_CONNECTOR FLUTTER_DRM_MODE FLUTTER_VT \
         ...
         FLUTTER_DRM_EXTERNAL_TEST FLUTTER_DRM_EXTERNAL_TEST_DEVICE \
         STARLING_SCREEN_SHELL STARLING_SCREEN_SHELL_DEVICE \
         ...
         STARLING_SWAPCHAIN_DEBUG STARLING_NO_NVENC STARLING_TEXT_DEBUG \
